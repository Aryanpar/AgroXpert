...
import '../services/tflite_service_stub.dart'
    if (dart.library.io) '../services/tflite_service.dart';
...
class _DiseaseDetectionScreenState extends State<DiseaseDetectionScreen> {
              ...
              child: _image == null
                  ...
                  : ClipRRect(
                      ...
                      child: kIsWeb 
                        ...
                        : Image.network(_image!.path, fit: BoxFit.cover), // Image.network works for XFile.path (blob on web)
                    ),
            ),
  ...
  Widget _buildPredictionResult() {
    ...
    // Update context service with scan result
    _contextService.updateScanResult(diseaseName);
